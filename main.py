...
# Import calculation functions from calculations.py
from calculations import (
    extract_audio_features,
    split_into_windows,
    calculate_cosine_similarity,
    analyze_similarity,
    calculate_filtered_mean_similarity
)
...
def generate_markdown_report(stats, patients_original_count, patients_windowed_count, icbhi_original_count, icbhi_windowed_count, output_dir='reports'):
    """
    ...
    with open(report_file, 'w') as f:
        ...
        f.write("|---------|-------------------|-------------------|-------|\n")
        f.write(f"| Patients | {patients_original_count} | {patients_windowed_count} | {len(stats['patients_segments'])} |\n")
        f.write(f"| ICBHI | {icbhi_original_count} | {icbhi_windowed_count} | {len(stats['icbhi_segments'])} |\n\n")
...
def main():
    ...
    generate_markdown_report(stats, patients_original_count, patients_windowed_count, icbhi_original_count, icbhi_windowed_count, 'reports')
